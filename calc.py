...
class Calculator:
    def __init__(self):
        ...
        self.operations = {"/": "\u00F7", "*": "\u00D7", "-": "-", "+": "+"} # \u00F7 division symbol, \u00D7 multiplication symbol, unicode 

        self.buttons_frame = self.create_buttons_frame()

        # As width is different from zero, will allow runs and collumns to expand
        # Once weight is different from 0
